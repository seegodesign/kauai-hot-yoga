    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('/images/cold-plunge-hero.jpg')",
          }}
        >
          <div className="absolute inset-0 bg-gradient-to-b from-ocean-dark/80 via-ocean-dark/60 to-ocean-dark/80" />
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            >
              <h2 className="text-lava mb-6">The Science of Cold</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <benefit.icon size={32} className="text-ocean mb-4" />
                  <h4 className="text-lava mb-2">{benefit.title}</h4>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-lava text-center mb-12">How It Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-mist p-8 rounded-2xl">
                <div className="text-ocean-dark text-4xl mb-4">1</div>
                <h3 className="text-lava mb-3">Prepare</h3>
              ...
              <div className="bg-mist p-8 rounded-2xl">
                <div className="text-ocean-dark text-4xl mb-4">2</div>
                <h3 className="text-lava mb-3">Plunge</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-mist p-8 rounded-2xl">
                <div className="text-ocean-dark text-4xl mb-4">3</div>
                <h3 className="text-lava mb-3">Warm Up</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-mist p-8 rounded-2xl">
                <div className="text-ocean-dark text-4xl mb-4">4</div>
                <h3 className="text-lava mb-3">Integrate</h3>
                <p className="text-muted-foreground">
      ...
      <section className="py-20 bg-sand">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-lava text-center mb-8">Safety First</h2>
            <div className="bg-white p-8 rounded-2xl border border-sand-dark">
              <p className="text-muted-foreground mb-6">
                Cold plunge is generally safe for most people, but please note:
              </p>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start space-x-3">
                  <span className="text-ocean-dark">•</span>
